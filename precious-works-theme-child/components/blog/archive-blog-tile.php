<?php $featured_image = get_the_post_thumbnail($id, 'landscape-thumbnail', array('class' => '')); ?>
<div class="single-post-tile">
    <a href="<?php echo $permalink; ?>" class="single-post-link" aria-label="Read more about <?php echo esc_attr($title); ?>">
        <div class="single-post-image-wrapper">
            ...
            $featured_image : 
            wp_get_attachment_image($default_blog_image, 'landscape-portrait', false, array('class' => 'w-100 h-auto')) ?>
        </div>
    </a>
